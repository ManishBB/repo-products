...
const NavBar = ({ role }) => {
    ...
    return (
        <div>
            <nav className="block w-full max-w-screen-xl px-4 py-2 mx-auto text-black bg-white border shadow-md rounded-xl border-white/80 bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
